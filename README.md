...
面板端：
```bash
curl -L https://raw.githubusercontent.com/loadinghtml/flux-panel-1.4.2/refs/heads/main/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
```
节点端：
```bash
curl -L https://raw.githubusercontent.com/loadinghtml/flux-panel-1.4.2/refs/heads/main//install.sh -o install.sh && chmod +x install.sh && ./install.sh
